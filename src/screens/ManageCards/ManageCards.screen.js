...
import { SafeAreaView, StatusBar, Text, View, TouchableOpacity, Image, TextInput } from "react-native"
...
const ManageCards = ({ navigation }) => {
    ...
    return (
        <>
                        ...
                        <View style={styles.container}>
                            ...
                            <View style={styles.formControl}>
                                <View style={styles.formInputContainer}>
                                    ...
                                    <TextInput style={styles.formInput} placeholder='0000 0000 0000 0000' />
                                </View>
                            </View>
                            ...
                            <Text style={styles.policyText}>By clicking the button below you agree to our Terms, Privacy Policy and Cookie Policy.</Text>
            ...
            <SafeAreaView>
                <NavHeader rightSection={XIcon} navigation={navigation} title="Manage Cards" />
                ...
                <View style={styles.topBtnContainer}>
                    <TouchableOpacity style={styles.btn}>
                        <View><Text style={styles.btnText}>Set as preferred</Text></View>
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.btn} onPress={showModal}>
                        <View><Text style={styles.btnText}>Add a new card</Text></View>
                    </TouchableOpacity>
                </View>

                <View style={styles.delBtnContainer}>
                    <TouchableOpacity style={styles.btn}>
                        <View><Text style={styles.btnText}>Delete this card</Text></View>
                    </TouchableOpacity>
                </View>
            </SafeAreaView>
